...
class NormaliseurAMV:
    ...
    avec fallback sémantique utilisant le glossaire pharmaceutique exhaustif.
    """
    ...
    def get_mapping_stats(self) -> Dict[str, int]:
        return {
            ...
            "termes_glossaire": len(self.termes_medicaments_semantiques)
        }

class PennyPetProcessor:
    """
    Pipeline extraction LLM, normalisation, calcul remboursement PennyPet.
    Prend en compte le glossaire pharma et le filtrage strict des règles.
    """
    def __init__(
        self,
